  ...
  static final List<NavMenuItemModel> items = [
    ...
    NavMenuItemModel(
      ...
      children: [
        ...
        NavSubItemModel(title: 'أقسام الخامات', route: Routes.materialSections),
        NavSubItemModel(title: 'الخامات', route: Routes.materials),
        NavSubItemModel(title: 'المستخدمين', route: Routes.users),
        NavSubItemModel(title: 'الصلاحيات', route: Routes.permissions),
        NavSubItemModel(title: 'الطيارين', route: Routes.drivers),
        NavSubItemModel(title: 'كابتن الصالة', route: Routes.captains),
        NavSubItemModel(title: 'الصالات', route: Routes.halls),
        NavSubItemModel(title: 'الطاولات', route: Routes.tables),
        NavSubItemModel(title: 'الأحجام/المقاسات', route: Routes.sizes),
        NavSubItemModel(title: 'مناطق التوصيل', route: Routes.deliveryZones),
      ],
    ),
