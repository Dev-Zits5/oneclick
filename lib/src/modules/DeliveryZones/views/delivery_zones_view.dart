...
import '../controllers/delivery_zones_controller.dart'; // <-- (تم التغيير)
...
class DeliveryZonesView extends GetView<DeliveryZonesController> { // <-- (تم التغيير)
  const DeliveryZonesView({super.key});
    ...
    return SingleChildScrollView(
      ...
      child: Table(
        ...
        columnWidths: const {
          ...
          1: FixedColumnWidth(150.0), // منطقة التوصيل
          2: FixedColumnWidth(150.0), // التكلفة
        },
        ...
        children: [
          ...
          TableRow(
            ...
            children: [
              ...
              buildHeaderCell('منطقة التوصيل', headerStyle),
              buildHeaderCell('التكلفة', headerStyle),
            ],
          ),
