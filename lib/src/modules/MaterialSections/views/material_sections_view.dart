...
import '../controllers/material_sections_controller.dart'; // <-- (تم التغيير)
...
class MaterialSectionsView extends GetView<MaterialSectionsController> { // <-- (تم التغيير)
  const MaterialSectionsView({super.key});
  ...
  Widget _buildPageTitleBar() {
    return Row(
      ...
      children: [
        const Text(
          'أقسام الخامات', // <-- (تم التعديل)
          textAlign: TextAlign.right,
          style: TextStyle(
            fontSize: 24,
            fontWeight: FontWeight.bold,
            fontFamily: 'Calibri', // (التأكيد على الخط)
    ...
    return SingleChildScrollView(
      ...
      child: Table(
        ...
        columnWidths: const {
          ...
          2: FixedColumnWidth(220.0), // الوصف
        },
